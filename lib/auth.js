 ...
 *
 *   MANAGING_DIRECTOR (CEO)  — sees ALL staff; may add/edit/delete any role
 *                              (MD, Operations Manager, Accountant, Driver, Rider).
 *   OPERATIONS_MANAGER       — delegated field staffing: sees ONLY drivers and
 *                              riders; may add/edit/reactivate them. Cannot see or
 *                              touch MD/Ops/Accountant accounts, cannot delete
 *                              accounts, cannot issue password resets.
 */
export const STAFF_MANAGE_ROLES = {
  MANAGING_DIRECTOR: ["MANAGING_DIRECTOR", "OPERATIONS_MANAGER", "ACCOUNTANT", "DRIVER", "RIDER"],
  OPERATIONS_MANAGER: ["DRIVER", "RIDER"],
};
